...
let footer = {
  social: {
    email: {
      text: 'vasia1415@gmail.com',
      href: 'mailto:vasia1415@gmail.com',
    },
    phone: {
      text: '+380670000123',
    ...
    linkedin: {
      text: 'LinkedIn',
      href: 'https://www.linkedin.com/in/vasyl-kaminskyi-1b4129252/',
    },
  },
}
...
router.get('/shopnews', function (req, res) {
  res.render('shopnews', {
    ...
    newsData: {
      photo: 'https://picsum.photos/1600/800',
...
router.get('/shopreview', function (req, res) {
  res.render('shopreview', {
    ...
    formBlock: {
      ...
      goodsInfo: {
        photo: 'https://picsum.photos/440/400',
        name: 'Ноут Asus',
        price: '25 000 ₴',
        buttons: [
          {
    ...
    reviewList: [
      ...
      },
      {
        ...
        reviewBody: {
          ...
          images: ['https://picsum.photos/440/400'],
          comments: [
            {
              userName: 'Користувач',
              date: '1 січня 2023',
